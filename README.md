...
### 프로젝트 소개
데이터 기반 중고차 구매 의사결정 지원을 위한 Streamlit 기반 웹 서비스로, 중고차 시장 분석과 실시간 정보 조회 서비스 제공
...
### 프로젝트 목표
- **데이터 기반 가성비 분석**: 가성비 지수 계산 및 TOP 10 추천
- **실시간 차량 정보 조회**: 약 7,000개 중고차 매물 검색 및 필터링 기능
- **정보 분석**: 브랜드별, 연식별, 차종별 통계 제공
- **통합 FAQ 서비스**: 현대/기아 공식 FAQ 통합 검색 시스템
...
| 작업명 | 담당자 | 기간 | 상태 |
|--------|--------|------|------|
| 자동차 크롤링 | 박준영 | 2025-09-03 | ✅  |
| FAQ 크롤링 | 김진 | 2025-09-03 | ✅  |
| 데이터 정제 | 박준영 | 2025-09-03 | ✅  |
...
| DB기획 | 정종현 | 2025-09-03 | ✅  |
| DB구현 | 박준영 | 2025-09-03 | ✅  |
| 데이터삽입 | 박준영 | 2025-09-03 | ✅  |
| DB테스트 | 김지훈 | 2025-09-03 | ✅  |

3단계: UI 개발
| 작업명 | 담당자 | 기간 | 상태 |
|--------|--------|------|------|
| 퍼블리싱 | 김지훈 | 2025-09-04 | ✅  |
| 프로그램개발 | 김지훈&김진 | 2025-09-04 | ✅  |
| 테스트 | 김지훈 | 2025-09-04 | ✅  |
| 산출물 정리 | 정종현 | 2025-09-04 | ✅  
---
...
- **데이터 수집**: K-Car에서 약 7000개 중고차 매물 자동 수집
- **FAQ 통합**: 현대 + 기아 = FAQ 통합
...
### 김진 (크롤링)
> 중고차 판매 사이트의 FAQ를 동적크롤링하여 DB에 저장하는 과정을 통해 실제 웹 데이터를 수집하는 경험을 얻었습니다. 데이터 기반으로 사용자 서비스를 제공하는 프로젝트를 진행하며 그동안 학습한 Python-SQL 연동,  크롤링, Streamlit의 전반적인 과정을 실제 적용해볼 수 있는 좋은 기회였습니다.

### 김지훈 (UI/UX)
> Streamlit을 활용해 데이터를 직관적으로 시각화하고, 사용자 중심의 대시보드를 구축하여 데이터에 의미를 부여하는 경험
